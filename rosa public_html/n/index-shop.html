      ...
      <div id="loader3">Please enable JS</div>
                  ...
                  <a href="index.html" class="clearfix">
					...
					<div class="main-menu-container">
                      ...
                      <li class="parent current">
                        ...
                        <li><a class="current" href="index-shop.html">Home - Shop</a></li>
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-8 plr-5">
                <div class="row">
                	...
                	<div class="col-md-6 col-sm-6 shop-dep-item mb-10">
                    <a href="shop-4-col.html">
                      <img src="images/shop/man-dep.jpg" alt="img">
                      <div class="shop-dep-text-cont">
                        <h4>MEN</h4>
                        <span>COLLECTION</span>
                      </div>
                ...
                <div class="row">
                    ...
                    <a href="shop-4-col.html">
                      ...
                      <div class="shop-dep-text-cont yellow-bg">
                        <h4><span class="sale-bold">SALE</span> EXTRA 30% OFF</h4>
                      </div> 
                    </a>
                  </div>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="shop-ad-height">
                  <div class="text-middle block-center-x-767">
                    <h3 class="light-34 m-0">NEW 2020 <br><span class="bold">COLLECTION</span></h3>
                  </div>
                </div>
              </div>
        ...
        <div class="page-section pt-110-b-30-cont">
          <div class="container">
            ...
            <div class="mb-50">
              <h2 class="section-title pr-0">BEST <span class="bold">SELLERS</span><a href="shop-4-col.html" class="section-more right">MORE</a>
                  </h2>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-3 col-lg-3 wow fadeIn pb-70" >
                ...
                <div class="post-prev-img">
                  <a href="shop-single.html"><img src="images/shop/items/1.jpg" alt="img"></a>
                </div>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3 wow fadeIn pb-70" data-wow-delay="200ms" >
                ...
                <div class="post-prev-img">
                  <a href="shop-single.html"><img src="images/shop/items/2.jpg" alt="img"></a>
                </div>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3 wow fadeIn pb-70" data-wow-delay="400ms" >
                ...
                <div class="post-prev-img">
                  <a href="shop-single.html"><img src="images/shop/items/3.jpg" alt="img"></a>
                </div>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3 wow fadeIn pb-70" data-wow-delay="600ms">
                ...
                <div class="post-prev-img">
                  <a href="shop-single.html"><img src="images/shop/items/4.jpg" alt="img"></a>
                </div>
            ...
            <ul class="port-grid display-hover-on-mobile port-grid-gut clearfix masonry" id="items-grid">
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-1.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-1.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-2-big.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-2-big.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="shop-single.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-3-very-big.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-3-very-big.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="shop-single.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-4-big.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-4-big.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="shop-single.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-5-big.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-5-big.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="shop-single.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-6.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-6.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="shop-single.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
              ...
              <li role="button" class="port-item mix">
                <a href="shop-single.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="images/shop/portfolio/projects-7.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/shop/portfolio/projects-7.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="shop-single.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
        ...
        <div class="port-view-more-cont">
          <a class="port-view-more" href="shop-4-col.html">VIEW ALL COLLECTION</a>
        </div>
        ...
        <div class="page-section p-110-cont">
            ...
            <div class="row client-row border-bot">
              ...
              <div class="col-xs-6 col-sm-2 client1-item ">
                <img alt="client" src="images/clients/9.png">
              </div>
            
              <div class="col-xs-6 col-sm-2 client1-item ">
                <img alt="client" src="images/clients/10.png">
              </div>
            ...
            <div class="row client-row">
              ...
              <div class="col-xs-6 col-sm-2 client1-item ">
                <img alt="client" src="images/clients/11.png">
              </div>
            
              <div class="col-xs-6 col-sm-2 client1-item">
                <img alt="client" src="images/clients/12.png">
              </div>
